...
| [0012](0012-recurring-jobs-persisted-to-postgres.md)                | Recurring jobs defined via cron expressions                    |
| [0013](0013-circuit-breaker-per-job-type.md)                        | Per-job-type circuit breaker with closed/open/half-open states |
